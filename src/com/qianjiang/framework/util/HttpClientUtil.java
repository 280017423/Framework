...
public class HttpClientUtil {
	 ...
	 *             业务异常
	 */
	public static JsonResult post(String url, HttpParams httpParams,
			List<NameValuePair> postParams) throws NetworkException,
			MessageException {
	 ...
	 *             业务异常
	 */
	public static JsonResult post(String url, int requestType,
			HttpParams httpParams, List<NameValuePair> postParams)
	 ...
	 */
	public static JsonResult post(String url, HttpParams httpParams,
			List<NameValuePair> postParams, List<File> fileList)
			throws NetworkException, MessageException,
	 ...
	 *             异常信息
	 */
	public static JsonResult get(String url, List<NameValuePair> getParams)
			throws NetworkException, MessageException {
	 ...
	 * @throws MessageException
	 */
	public static JsonResult get(String url, int requestType,
	 ...
	 * @throws NetworkException
	 */
	public static JsonResult get(String url, HttpParams httpParams,
			List<NameValuePair> getParams) throws NetworkException,
			MessageException {
		return PDW_HTTP_CLIENT.get(url, getParams);
	}
	 ...
	 */
	public static JsonResult get(String url, int requestType,
			HttpParams httpParams, List<NameValuePair> getParams)
			throws NetworkException, MessageException {
		return PDW_HTTP_CLIENT.get(url, requestType, getParams);
	}
	 ...
	 * @throws
	 */
	public static JsonResult getByString(String url,
			List<NameValuePair> getParams) throws NetworkException {
	 ...
	 * @throws Exception
	 */
	public static HttpResponse getResponse(String url, HttpParams httpParams,
			List<NameValuePair> getParams) throws NetworkException {
	 ...
	 * @throws Exception
	 */
	public static HttpResponse getResponse(String url, int requestType,
			HttpParams httpParams, List<NameValuePair> getParams)
			throws NetworkException {
		return PDW_HTTP_CLIENT.getResponse(url, requestType, httpParams,
				getParams);
	}
	...
	public static String encodeUrl(UrlParameters parameters) {
		...
		for (int loc = 0; loc < parameters.size(); loc++) {
			...
			String value = (parameters.getValue(loc) == null || ""
					.equals(parameters.getValue(loc))) ? "" : URLEncoder
