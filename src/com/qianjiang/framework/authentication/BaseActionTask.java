...
public abstract class BaseActionTask<T extends BaseActionResult> {
	 ...
	 * 
	 * @author tan.xx
	 * @version 2013-12-12 下午2:27:15 tan.xx TODO
	 */
	...
	public class BaseTask extends AsyncTask<Void, Void, T> {
		...
		protected T doInBackground(Void... params) {
			...
			if (mIsCancelLogin) {
				...
				IBaseActionListener<T> mListener = mAction.getListener();
				if (mListener == null) {
					return null;
				}
				T result = (T) mListener.onAsyncRun();
				// 子线程回调
				if (!mAction.isOnUiThreadCallBack()) {
	 ...
	 * 
	 * @author tan.xx
	 * @version 2013-12-25 下午3:53:56 tan.xx TODO
	 */
