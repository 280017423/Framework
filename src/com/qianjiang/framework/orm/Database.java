...
public class Database {
	 ...
	 *            Database version
	 * @param context
	 *            The context used for database creation, its package name will be used to place the database on
	 *            external storage if any is present, otherwise the context's application data directory.
	 */
	...
	/**
	 * Initializes Database framework. This method must be called for each used database only once before using
	 * database. This is required for proper setup static attributes of the Database
	 * 
	 * @param builder
	 *            DatabaseBuilder
	 * @return
	...
	/**
	 * Execute a single SQL statement that is not a query. For example, CREATE TABLE, DELETE, INSERT, etc. Multiple
	 * statements separated by ;s are not supported. it takes a write lock
	 * 
	 * @param sql
	 *            要执行的语句
	 */
